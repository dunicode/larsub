...
Route::get('/subscriptions', [App\Http\Controllers\SubscriptionController::class, 'list'])->name('subscription.list');
...
Route::post('/paypal/cancel-subscription/{subscriptionId}', [App\Http\Controllers\PayPalController::class, 'cancelSubscription'])->name('subscription.close');
